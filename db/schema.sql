...
CREATE TABLE IF NOT EXISTS MODULES (
  module_id CHAR(36) CHARACTER SET utf8mb4,
  ...
  min_assignments INT DEFAULT 1, CHECK (min_assignments >=0) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  ASSIGNMENTS (
  assignment_id CHAR(36) CHARACTER SET utf8mb4,
  module_id CHAR(36) CHARACTER SET utf8mb4 NOT NULL,
  ...
  submit_date DATE,
  status ENUM('Not Started','In Progress','Done','Skipped') DEFAULT 'Not Started',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (assignment_id),
  FOREIGN KEY (module_id) REFERENCES MODULES(module_id) ON UPDATE CASCADE
) ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS MARKS (
  mark_id CHAR(36) CHARACTER SET utf8mb4,
  assignment_id CHAR(36) CHARACTER SET utf8mb4 UNIQUE NOT NULL,
